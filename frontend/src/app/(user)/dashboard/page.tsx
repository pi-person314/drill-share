            ...
            <div className="flex flex-col space-y-28 max-w-400 w-full h-full">
                ...
                <div className="flex-1 flex flex-col 2xl:flex-row space-x-0 2xl:space-x-16 space-y-16 2xl:space-y-0 min-h-0">
                    <div className="flex-1 flex flex-col space-y-2">
                        ...
                        <div className="flex-1 grid [grid-template-columns:repeat(auto-fit,minmax(20rem,1fr))] justify-items-center overflow-y-auto auto-rows-max gap-y-20 p-6 mt-4 overflow-x-hidden border rounded-lg shadow-lg">
