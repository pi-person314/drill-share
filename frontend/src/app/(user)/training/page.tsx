...
export default function Training() {
    ...
    return (
        <main className="flex-1 flex flex-col justify-center items-center [@media(max-height:60rem)]:space-y-8 space-y-16 p-16 [@media(max-height:60rem)]:p-8">
            ...
            <div className="[@media(max-height:60rem)]:flex-1 flex flex-col xl:flex-row justify-around items-center [@media(max-height:60rem, max-width:1279px)]:space-y-8 space-y-16 xl:space-y-0 xl:h-3/5 p-4 pb-8 xl:w-4/5 overflow-y-auto">
